...
SOURCE_DIR="/home/alberto/Documentos/PI-IB-2025/sel4-tutorials-manifest/hello-camkes-1_build/images"
#SOURCE_DIR="/home/alberto/Documentos/PI-IB-2025/camkes-vm-examples-manifest/build_optiplex/images"
CWD=$(pwd)
DEST_DIR="$CWD/isohello"
...
grub-mkrescue -o "$CWD/isohello/image.iso" "$CWD/isohello"